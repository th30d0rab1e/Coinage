-- Drop transfer_amount and transfer_complete from position.
-- Coinbase convert API only works on default portfolio; transfers are abandoned.

ALTER TABLE position DROP COLUMN transfer_amount;
ALTER TABLE position DROP COLUMN transfer_complete;
