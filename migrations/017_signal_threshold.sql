-- Tighten buy threshold: only buy when current period dip is >= 1 standard
-- deviation below the historical average (signal < -1).
-- Previously fired on any negative signal, resulting in a 13% win rate.
