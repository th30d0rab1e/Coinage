-- Drop buy_fills_id from position; profit_history uses buy_coinbase_order_id instead

ALTER TABLE profit_history RENAME COLUMN buy_fills_id TO buy_coinbase_order_id;

ALTER TABLE position DROP COLUMN buy_fills_id;
