-- Only buy when score > 5. Score = period_count * avg_change_percent / std_dev,
-- a Sharpe-like metric weighting signal quality by historical reliability and
-- data depth. Filters out assets with weak or unreliable historical performance.
